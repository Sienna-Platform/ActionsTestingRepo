...
```@meta
CurrentModule = MockPackage
```

## Overview

`MockPackage.jl` is a [`Julia`](http://www.julialang.org) package that provides blah blah

## About

`MockPackage` is part of the National Renewable Energy Laboratory's
